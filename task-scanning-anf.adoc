...
扫描 Azure NetApp Files 卷之前， https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-manage-anf.html["必须设置 Cloud Manager 才能发现配置"^]。
...
https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-manage-anf.html["了解如何在 Cloud Manager 中发现 Azure NetApp Files 系统"^]。
